    ...
    return (
        <div className="flex flex-col md:flex-row w-[90%] items-center py-10 px-8 gap-12 h-full my-12 mx-auto bg-white shadow-lg rounded-lg">
            ...
            <div className="flex-1 md:text-left space-y-6">
                ...
                <div>
                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="username">Nama perusahaan</label>
                    <input 
                        type="text" 
                        id="Namaperusahaan" 
                        name="Namaperusahaan" 
                ...
                <div>
                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="password">Password confirm:</label>
                    <input 
                        type="password" 
                        id="passwordconfirm" 
